...
public class SimpleStreamApi {
    List<Double> numbers = new ArrayList<>(Arrays.asList(13.11, 16.66, 7.0, 33.43, 9.999999, 1.0, -20.0));
    ...
    // metoda wypisujaca wszystkie liczby oddzielone wybranym separatorem
    ...
    // metoda zwracajaca najmnieksza liczbe
    ...
    // metoda zwracajaca najwieksza liczbe
    ...
    // metoda zwracajaca srednia arytmetyczna
